...
const ru = {
  ...
  pageSubtitles: {
    ...
    abcXyz: "ABC/XYZ анализ ассортимента",
  ...
  pim: {
    ...
    products: "Товары", brands: "Бренды", categories: "Категории",
    search: "Поиск по названию или ID",
    noProducts: "Нет товаров в PIM",
    noBrands: "Нет брендов",
    noCategories: "Нет категорий",
    addBrand: "Добавить бренд",
    addCategory: "Добавить категорию",
    edit: "Редактировать",
    generateDesc: "Сгенерировать описание (AI)",
    save: "Сохранить",
    bulkSave: "Сохранить все",
    applyToMp: "Отправить на маркетплейс",
  },
};
...
const en = {
  ...
  pageSubtitles: {
    ...
    abcXyz: "ABC/XYZ assortment analysis",
