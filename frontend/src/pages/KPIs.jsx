  ...
  return (
    <div className="space-y-4">
      <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
        <MetricCard label="Revenue 30d" value={moneyFmt(sum(rows, "revenue_30d"))} accent="success" className="col-span-2" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-3">
        ...
        <MetricCard label="Accounts" value={numberFmt(rows.length)} />
      </div>

      <section className="md3-card-elevated p-4">
        <h3 className="text-sm font-semibold text-[var(--color-on-surface)] mb-3">KPI 30d</h3>
