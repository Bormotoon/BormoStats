...
import structlog
from app.api.v1 import abc_xyz, accounts, admin, ads, ai, bidder, costs, extension, funnel, insights, kpis, organizations, pim, plugin, pnl, repricer, sales, stocks, users
...
app.include_router(pim.router, prefix="/api/v1")
